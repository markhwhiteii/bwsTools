...
Now, the data are in the correct format for using the `bwsTools` individual scoring functions. Using these individual-level data to aggregate up follows the same procedure as above.  
